...
public class DataUtil {
	...
	public DataUtil(){
		try {
			clazz=Class.forName("com.projity.server.data.Serializer");
	...
	public static void setEnterpriseResources(Collection resources,ResourcePool resourcePool) throws IOException, ClassNotFoundException{
		try {
			Class.forName("com.projity.server.data.Serializer").getMethod("setEnterpriseResources", new Class[]{Collection.class,ResourcePool.class, Session.class}).invoke(null, new Object[]{resources,resourcePool,null});
		} catch (IllegalArgumentException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		} catch (SecurityException e) {
