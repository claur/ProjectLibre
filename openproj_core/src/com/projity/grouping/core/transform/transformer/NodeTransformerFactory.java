...
*/
package com.projity.grouping.core.transform.transformer;
...
//	static Log log = LogFactory.getLog(NodeTransformerFactory.class);
	...
	public CommonTransform getTransform() throws InvalidFormulaException{
	    ...
	    classText.append("package com.projity.grouping.core.transform.transformer;\n");
	    classText.append("import com.projity.grouping.core.Node;\n");
	    classText.append("import com.projity.datatype.*;\n");
	    classText.append("import com.projity.pm.assignment.Assignment;\n");
