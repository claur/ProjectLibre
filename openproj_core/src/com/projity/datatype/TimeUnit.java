...
public interface TimeUnit {
	   ...
	   public static final int NON_TEMPORAL = -2; // projity specific to indicate the value is not temporal
		
	   public static final int NONE = -1; // projity specific to indicate no value entered
