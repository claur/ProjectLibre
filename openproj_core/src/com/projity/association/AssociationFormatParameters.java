...
public class AssociationFormatParameters {
	...
	public static AssociationFormatParameters getInstance(HasDependencies thisObject,boolean leftAssociation, com.projity.field.Field idField, boolean encloseInBrackets, boolean allowDetailsEntry) {
		return new AssociationFormatParameters(thisObject,leftAssociation,idField, encloseInBrackets, allowDetailsEntry);
	}
	
	private AssociationFormatParameters(HasDependencies thisObject,boolean leftAssociation, com.projity.field.Field idField, boolean encloseInBrackets, boolean allowDetailsEntry) {
