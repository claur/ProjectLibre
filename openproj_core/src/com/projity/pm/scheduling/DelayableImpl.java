...
public class DelayableImpl implements Delayable, Cloneable {
	...
	/* (non-Javadoc)
	 * @see com.projity.pm.scheduling.Delayable#calcTotalDelay()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projity.pm.scheduling.Delayable#setDelay(long)
	 */
...
//		System.out.println("setting delay" + delay);
	...
	/* (non-Javadoc)
	 * @see com.projity.pm.scheduling.Delayable#setLevelingDelay(long)
	 */
