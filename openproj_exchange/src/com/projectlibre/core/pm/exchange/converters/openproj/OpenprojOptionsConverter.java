 ...
 *
 */
public class OpenprojOptionsConverter {
	public static void to(com.projity.options.CalendarOption openprojCalendarOptions, CalendarOptions calendarOptions, OpenprojImportState state) {
		openprojCalendarOptions.setHoursPerDay(calendarOptions.getHoursPerDay());
		openprojCalendarOptions.setHoursPerWeek(calendarOptions.getHoursPerWeek());
		openprojCalendarOptions.setDaysPerMonth(calendarOptions.getDaysPerMonth());
		if (calendarOptions.getDefaultStart()>0){
			...
			openprojCalendarOptions.setDefaultStartTime(defaultStart);			
		}
		if (calendarOptions.getDefaultEnd()>0){
			...
			openprojCalendarOptions.setDefaultEndTime(defaultEnd);			
		}
	}
}
