 ...
 *
 */
public class OpenprojTaskConverter {
	protected static Logger log = Logger.getLogger("OpenprojTaskConverter");
	protected String[] fieldsToConvert=new String[]{
		...
		"duration", "duration", "com.projectlibre.core.pm.exchange.converters.openproj.type.OpenprojDurationConverter",
		"estimated", "estimated", null,
		"levelingDelay", "levelingDelay", "com.projectlibre.core.pm.exchange.converters.openproj.type.OpenprojDurationConverter",
		...
		"earnedValueMethod","earnedValueMethod", "com.projectlibre.core.pm.exchange.converters.openproj.type.OpenprojEarnedValueMethodConverter",
