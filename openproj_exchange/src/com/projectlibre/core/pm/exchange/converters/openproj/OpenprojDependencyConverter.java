...
import com.projectlibre.core.pm.exchange.converters.openproj.type.OpenprojDependencyTypeConverter;
import com.projectlibre.core.pm.exchange.converters.openproj.type.OpenprojDurationConverter;
...
public class OpenprojDependencyConverter {
	...
	public com.projity.pm.dependency.Dependency to(Dependency dependency, OpenprojImportState state) {
		...
		try {
			...
			OpenprojDependencyTypeConverter dependencyTypeConverter=new OpenprojDependencyTypeConverter();
			int openprojDependencyType=(Integer)dependencyTypeConverter.to(dependency.getType());
			
			openprojDependency = DependencyService.getInstance().newDependency(
					predecessor, successor, openprojDependencyType, openprojDuration, null); //claur, mpxj classes have changed
		} catch (InvalidAssociationException e) {
			openprojDependency=null;
		}
		return openprojDependency;
	}	
}
