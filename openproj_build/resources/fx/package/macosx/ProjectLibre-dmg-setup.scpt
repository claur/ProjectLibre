tell application "Finder"
  tell disk "ProjectLibre"
    ...
    set the bounds of container window to {400, 100, 917, 420}
    ...
    repeat with theFile in allTheFiles
      ...
      if theFilePath is "/ProjectLibre.app"
        -- Position application location
        set position of item theFile of container window to {120, 55}
      else if theFilePath is "/Applications"
        -- Position install location
        set position of item theFile of container window to {390, 55}
      else
