...
public class AssociationFormatParameters {
	...
	com.projectlibre1.field.Field idField;
	boolean encloseInBrackets = false;
	private String error;
	private boolean allowDetailsEntry;
	public static AssociationFormatParameters getInstance(HasDependencies thisObject,boolean leftAssociation, com.projectlibre1.field.Field idField, boolean encloseInBrackets, boolean allowDetailsEntry) {
		return new AssociationFormatParameters(thisObject,leftAssociation,idField, encloseInBrackets, allowDetailsEntry);
	}
	
	private AssociationFormatParameters(HasDependencies thisObject,boolean leftAssociation, com.projectlibre1.field.Field idField, boolean encloseInBrackets, boolean allowDetailsEntry) {
	 ...
	 */
	public com.projectlibre1.field.Field getIdField() {
		return idField;
	}
	/**
