...
public class SnapshottableImpl implements Snapshottable, Serializable {
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.snapshot.Snapshottable#getSnapshot(int)
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.snapshot.Snapshottable#setSnapshot(int, com.projectlibre1.pm.snapshot.DataSnapshot)
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.snapshot.Snapshottable#cloneSnapshot()
	 */
