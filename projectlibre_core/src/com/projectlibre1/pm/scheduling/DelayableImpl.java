...
public class DelayableImpl implements Delayable, Cloneable {
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.scheduling.Delayable#calcTotalDelay()
	 */
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.scheduling.Delayable#setDelay(long)
	 */
...
//		System.out.println("setting delay" + delay);
	...
	/* (non-Javadoc)
	 * @see com.projectlibre1.pm.scheduling.Delayable#setLevelingDelay(long)
	 */
