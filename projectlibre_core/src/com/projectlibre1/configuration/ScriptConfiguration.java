...
public class ScriptConfiguration implements ClassResolverFilter{
	...
	public static void addDigesterEvents(Digester digester){
		digester.addObjectCreate("*/script", "com.projectlibre1.configuration.ScriptConfiguration");
	    digester.addSetProperties("*/script");
		digester.addSetNext("*/script", "setScriptConfiguration", "com.projectlibre1.configuration.ScriptConfiguration");

		digester.addObjectCreate("*/script/class", "com.projectlibre1.configuration.ScriptClass");
	    digester.addSetProperties("*/script/class");
		digester.addSetNext("*/script/class", "addClassToResolve", "com.projectlibre1.configuration.ScriptClass");
