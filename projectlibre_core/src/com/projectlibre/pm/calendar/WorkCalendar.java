...
public interface WorkCalendar {
	...
	public abstract void setWeeks(List<WorkWeek> weeks);
	public abstract List<WorkWeek> getWeeks();
	public abstract WorkWeek getWeek();
	public abstract void setWeek(WorkWeek week);
	public abstract void setExceptions(List<WorkCalendarException> exceptions);
	public abstract List<WorkCalendarException> getExceptions();
	public abstract boolean addException(WorkCalendarException exception);
	public abstract void setBase(WorkCalendar base);
	public abstract WorkCalendar getBase();
