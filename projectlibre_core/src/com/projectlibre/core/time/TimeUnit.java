 ...
 * 
 * contants from mpxj with 2 additional ones from OpenProj
 */
public enum TimeUnit{
	
	/**
	 * projity specific to indicate the value is not temporal
	 */
	NON_TEMPORAL(-2,""), //-2 in OpenProj

	/**
	 * projity specific to indicate no value entered
	 */
	NONE(-1,""), //-1 in OpenProj
