...
}) @SuppressWarnings("all") public class ResourceRequestType
{
   ...
   @XmlElementRef(name = "RequestedUnits", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Double> requestedUnits;
   ...
   {
      this.requestedUnits = ((JAXBElement<Double>) value);
   }
