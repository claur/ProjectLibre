 ...
 *         &lt;element name="Privileges" type="{http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects}ProjectPrivilegesType"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ProjectProfileType", propOrder =
{
   ...
   "objectId",
   "privileges"
}) @SuppressWarnings("all") public class ProjectProfileType
{
   ...
   @XmlElementRef(name = "IsSuperUser", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Boolean> isSuperUser;
    ...
    *     
    */
   public JAXBElement<Boolean> getIsSuperUser()
   {
      return isSuperUser;
   }
    ...
    *     
    */
   public void setIsSuperUser(JAXBElement<Boolean> value)
   {
      this.isSuperUser = ((JAXBElement<Boolean>) value);
   }
