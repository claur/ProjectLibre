...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ProjectThresholdType", propOrder =
{
   ...
   "wbsName",
   "wbsObjectId"
}) @SuppressWarnings("all") public class ProjectThresholdType
{
   ...
   @XmlElementRef(name = "FromDate", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Date> fromDate;
   ...
   @XmlElementRef(name = "ToDate", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Date> toDate;
    ...
    *     
    */
   public JAXBElement<Date> getFromDate()
   {
      return fromDate;
   }
    ...
    *     
    */
   public void setFromDate(JAXBElement<Date> value)
   {
      this.fromDate = ((JAXBElement<Date>) value);
   }
    ...
    *     
    */
   public JAXBElement<Date> getToDate()
   {
      return toDate;
   }
    ...
    *     
    */
   public void setToDate(JAXBElement<Date> value)
   {
      this.toDate = ((JAXBElement<Date>) value);
   }
