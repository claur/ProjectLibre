...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ActivityStepType", propOrder =
{
   ...
   "weightPercent",
   "udf"
}) @SuppressWarnings("all") public class ActivityStepType
{
   ...
   @XmlElementRef(name = "WeightPercent", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Double> weightPercent;
    ...
    *     
    */
   public JAXBElement<Double> getWeightPercent()
   {
    ...
    *     
    */
   public void setWeightPercent(JAXBElement<Double> value)
   {
      this.weightPercent = ((JAXBElement<Double>) value);
   }
