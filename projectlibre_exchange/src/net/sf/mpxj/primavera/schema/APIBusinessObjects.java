...
}) @XmlRootElement(name = "APIBusinessObjects") public class APIBusinessObjects
{
   ...
   @XmlElement(name = "RiskType") protected List<RiskTypeType> riskType;
   ...
   @XmlElement(name = "BatchReport") protected List<BatchReportType> batchReport;
   ...
   @XmlElement(name = "Initiation") protected List<InitiationType> initiation;
   @XmlElement(name = "IssueHistory") protected List<IssueHistoryType> issueHistory;
   @XmlElement(name = "Methodology") protected List<MethodologyType> methodology;
   ...
   @XmlElement(name = "ProjectCodeUser") protected List<ProjectCodeUserType> projectCodeUser;
    ...
    * not a snapshot. Therefore any modification you make to the
    * returned list will be present inside the JAXB object.
    * This is why there is not a <CODE>set</CODE> method for the riskType property.
    * 
    * <p>
    * For example, to add a new item, do as follows:
    * <pre>
   ...
   public List<RiskTypeType> getRiskType()
   {
      if (riskType == null)
      {
         riskType = new ArrayList<RiskTypeType>();
      }
    ...
    * not a snapshot. Therefore any modification you make to the
    * returned list will be present inside the JAXB object.
    * This is why there is not a <CODE>set</CODE> method for the batchReport property.
    * 
    * <p>
    * For example, to add a new item, do as follows:
    * <pre>
   ...
   public List<BatchReportType> getBatchReport()
   {
      if (batchReport == null)
      {
         batchReport = new ArrayList<BatchReportType>();
      }
    ...
    * not a snapshot. Therefore any modification you make to the
    * returned list will be present inside the JAXB object.
    * This is why there is not a <CODE>set</CODE> method for the initiation property.
    * 
    * <p>
    * For example, to add a new item, do as follows:
    * <pre>
   ...
   public List<InitiationType> getInitiation()
   {
      if (initiation == null)
      {
         initiation = new ArrayList<InitiationType>();
      }
   ...
   public List<MethodologyType> getMethodology()
   {
      if (methodology == null)
      {
         methodology = new ArrayList<MethodologyType>();
      }
    ...
    * not a snapshot. Therefore any modification you make to the
    * returned list will be present inside the JAXB object.
    * This is why there is not a <CODE>set</CODE> method for the projectCodeUser property.
    * 
    * <p>
    * For example, to add a new item, do as follows:
    * <pre>
    ...
    * <p>
    * Objects of the following type(s) are allowed in the list
    * {@link ProjectCodeUserType }
    * 
    * 
    */
   public List<ProjectCodeUserType> getProjectCodeUser()
   {
      if (projectCodeUser == null)
      {
         projectCodeUser = new ArrayList<ProjectCodeUserType>();
      }
      return this.projectCodeUser;
   }
