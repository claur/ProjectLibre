...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ProjectCodeUserType", propOrder =
{
   ...
   "userName",
   "userObjectId"
}) @SuppressWarnings("all") public class ProjectCodeUserType
{

   @XmlElement(name = "CodeObjectId") protected Integer codeObjectId;
   @XmlElementRef(name = "CodeTypeObjectId", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Integer> codeTypeObjectId;
    ...
    *     
    */
   public void setCodeTypeObjectId(JAXBElement<Integer> value)
   {
      this.codeTypeObjectId = ((JAXBElement<Integer>) value);
   }
