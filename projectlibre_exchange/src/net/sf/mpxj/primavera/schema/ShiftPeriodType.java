...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ShiftPeriodType", propOrder =
{
   ...
   "objectId",
   "startHour"
}) @SuppressWarnings("all") public class ShiftPeriodType
{
   ...
   @XmlElementRef(name = "StartHour", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Integer> startHour;
    ...
    *     
    */
   public JAXBElement<Integer> getStartHour()
   {
      return startHour;
   }
    ...
    *     
    */
   public void setStartHour(JAXBElement<Integer> value)
   {
      this.startHour = ((JAXBElement<Integer>) value);
   }
