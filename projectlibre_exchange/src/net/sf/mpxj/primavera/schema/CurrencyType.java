...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "CurrencyType", propOrder =
{
   ...
   "positiveSymbol",
   "symbol"
}) @SuppressWarnings("all") public class CurrencyType
{
   ...
   @XmlElementRef(name = "IsBaseCurrency", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Boolean> isBaseCurrency;
   ...
   {
      this.isBaseCurrency = ((JAXBElement<Boolean>) value);
   }
