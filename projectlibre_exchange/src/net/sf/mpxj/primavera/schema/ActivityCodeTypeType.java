...
@XmlAccessorType(XmlAccessType.FIELD) @XmlType(name = "ActivityCodeTypeType", propOrder =
{
   ...
   "scope",
   "sequenceNumber"
}) @SuppressWarnings("all") public class ActivityCodeTypeType
{
   ...
   @XmlElementRef(name = "EPSObjectId", namespace = "http://xmlns.oracle.com/Primavera/P6/V7/API/BusinessObjects", type = JAXBElement.class) protected JAXBElement<Integer> epsObjectId;
    ...
    *     
    */
   public JAXBElement<Integer> getEPSObjectId()
   {
      return epsObjectId;
   }
    ...
    *     
    */
   public void setEPSObjectId(JAXBElement<Integer> value)
   {
      this.epsObjectId = ((JAXBElement<Integer>) value);
   }
