...
class FieldMap14 extends FieldMap
{
   ...
   @Override protected FieldItem[] getDefaultTaskData()
   {
      FieldItem[] result = new FieldItem[]
      {
         ...
         new FieldItem(TaskField.SCHEDULED_DURATION, FieldLocation.FIXED_DATA, 0, 42, 29),
         new FieldItem(TaskField.ACTUAL_DURATION_UNITS, FieldLocation.FIXED_DATA, 0, 46, 181),
         new FieldItem(TaskField.ACTUAL_DURATION, FieldLocation.FIXED_DATA, 0, 48, 28),
         new FieldItem(TaskField.REMAINING_DURATION, FieldLocation.FIXED_DATA, 0, 52, 31),
         new FieldItem(TaskField.CONSTRAINT_TYPE, FieldLocation.FIXED_DATA, 0, 56, 17),
         new FieldItem(TaskField.LEVELING_DELAY, FieldLocation.FIXED_DATA, 0, 58, 20),
         new FieldItem(TaskField.LEVELING_DELAY_UNITS, FieldLocation.FIXED_DATA, 0, 62, 178),
         new FieldItem(TaskField.SCHEDULED_START, FieldLocation.FIXED_DATA, 0, 64, 35),
         new FieldItem(TaskField.SCHEDULED_FINISH, FieldLocation.FIXED_DATA, 0, 68, 36),
         new FieldItem(TaskField.ACTUAL_START, FieldLocation.FIXED_DATA, 0, 72, 41),
         new FieldItem(TaskField.ACTUAL_FINISH, FieldLocation.FIXED_DATA, 0, 76, 42),
         new FieldItem(TaskField.CONSTRAINT_DATE, FieldLocation.FIXED_DATA, 0, 80, 18),
         new FieldItem(TaskField.RESUME_NO_EARLIER_THAN, FieldLocation.FIXED_DATA, 0, 84, 101),
         new FieldItem(TaskField.PRIORITY, FieldLocation.FIXED_DATA, 0, 88, 25),
         new FieldItem(TaskField.PERCENT_COMPLETE, FieldLocation.FIXED_DATA, 0, 90, 32),
         new FieldItem(TaskField.PERCENT_WORK_COMPLETE, FieldLocation.FIXED_DATA, 0, 92, 33),
         new FieldItem(TaskField.TYPE, FieldLocation.FIXED_DATA, 0, 94, 128),
         new FieldItem(TaskField.FIXED_COST_ACCRUAL, FieldLocation.FIXED_DATA, 0, 96, 200),
         new FieldItem(TaskField.CREATED, FieldLocation.FIXED_DATA, 0, 98, 93),
         new FieldItem(TaskField.EARLY_START, FieldLocation.FIXED_DATA, 0, 106, 37),
         new FieldItem(TaskField.LATE_FINISH, FieldLocation.FIXED_DATA, 0, 110, 40),
         new FieldItem(TaskField.SUMMARY_PROGRESS, FieldLocation.FIXED_DATA, 0, 114, 387),
         new FieldItem(TaskField.CALENDAR_UNIQUE_ID, FieldLocation.FIXED_DATA, 0, 118, 401),
         new FieldItem(TaskField.DEADLINE, FieldLocation.FIXED_DATA, 0, 122, 437),
         new FieldItem(TaskField.WORK, FieldLocation.FIXED_DATA, 0, 126, 0),
         new FieldItem(TaskField.ACTUAL_WORK, FieldLocation.FIXED_DATA, 0, 134, 2),
         new FieldItem(TaskField.REMAINING_WORK, FieldLocation.FIXED_DATA, 0, 142, 4),
         new FieldItem(TaskField.COST, FieldLocation.FIXED_DATA, 0, 150, 5),
         new FieldItem(TaskField.FIXED_COST, FieldLocation.FIXED_DATA, 0, 158, 8),
         new FieldItem(TaskField.ACTUAL_COST, FieldLocation.FIXED_DATA, 0, 166, 7),
         new FieldItem(TaskField.REMAINING_COST, FieldLocation.FIXED_DATA, 0, 174, 10),
         new FieldItem(TaskField.BASELINE_FIXED_COST, FieldLocation.FIXED_DATA, 0, 198, 480),
         ...
         new FieldItem(TaskField.PRELEVELED_START, FieldLocation.VAR_DATA, 0, 65535, 369),
         new FieldItem(TaskField.PRELEVELED_FINISH, FieldLocation.VAR_DATA, 0, 65535, 370),
         new FieldItem(TaskField.BASELINE_ESTIMATED_START, FieldLocation.VAR_DATA, 0, 65535, 43),
         new FieldItem(TaskField.BASELINE_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 0, 65535, 44),
         new FieldItem(TaskField.BASELINE_COST, FieldLocation.VAR_DATA, 0, 65535, 6),
         new FieldItem(TaskField.BASELINE_WORK, FieldLocation.VAR_DATA, 0, 65535, 1),
         new FieldItem(TaskField.BASELINE_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 0, 65535, 27),
         new FieldItem(TaskField.BASELINE_DURATION_UNITS, FieldLocation.VAR_DATA, 0, 65535, 179),
         ...
         new FieldItem(TaskField.BASELINE_FIXED_COST_ACCRUAL, FieldLocation.FIXED_DATA, 1, 40, 1173),
         new FieldItem(TaskField.RECALC_OUTLINE_CODES, FieldLocation.FIXED_DATA, 1, 42, 1250),
         new FieldItem(TaskField.START, FieldLocation.FIXED_DATA, 1, 50, 1283),
         new FieldItem(TaskField.FINISH, FieldLocation.FIXED_DATA, 1, 54, 1284),
         new FieldItem(TaskField.MANUAL_DURATION, FieldLocation.FIXED_DATA, 1, 58, 1288),
         new FieldItem(TaskField.MANUAL_DURATION_UNITS, FieldLocation.FIXED_DATA, 1, 62, 1289),
         new FieldItem(TaskField.ENTERPRISE_DATA, FieldLocation.VAR_DATA, 1, 65535, 481),
         new FieldItem(TaskField.BASELINE1_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 482),
         new FieldItem(TaskField.BASELINE1_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 483),
         ...
         new FieldItem(TaskField.BASELINE1_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 487),
         ...
         new FieldItem(TaskField.BASELINE2_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 493),
         new FieldItem(TaskField.BASELINE2_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 494),
         ...
         new FieldItem(TaskField.BASELINE2_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 498),
         ...
         new FieldItem(TaskField.BASELINE3_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 504),
         new FieldItem(TaskField.BASELINE3_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 505),
         ...
         new FieldItem(TaskField.BASELINE3_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 509),
         ...
         new FieldItem(TaskField.BASELINE4_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 515),
         new FieldItem(TaskField.BASELINE4_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 516),
         ...
         new FieldItem(TaskField.BASELINE4_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 520),
         ...
         new FieldItem(TaskField.BASELINE5_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 526),
         new FieldItem(TaskField.BASELINE5_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 527),
         ...
         new FieldItem(TaskField.BASELINE5_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 531),
         ...
         new FieldItem(TaskField.BASELINE6_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 544),
         new FieldItem(TaskField.BASELINE6_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 545),
         ...
         new FieldItem(TaskField.BASELINE6_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 549),
         ...
         new FieldItem(TaskField.BASELINE7_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 555),
         new FieldItem(TaskField.BASELINE7_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 556),
         ...
         new FieldItem(TaskField.BASELINE7_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 560),
         ...
         new FieldItem(TaskField.BASELINE8_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 566),
         new FieldItem(TaskField.BASELINE8_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 567),
         ...
         new FieldItem(TaskField.BASELINE8_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 571),
         ...
         new FieldItem(TaskField.BASELINE9_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 577),
         new FieldItem(TaskField.BASELINE9_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 578),
         ...
         new FieldItem(TaskField.BASELINE9_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 582),
         ...
         new FieldItem(TaskField.BASELINE10_ESTIMATED_START, FieldLocation.VAR_DATA, 1, 65535, 588),
         new FieldItem(TaskField.BASELINE10_ESTIMATED_FINISH, FieldLocation.VAR_DATA, 1, 65535, 589),
         ...
         new FieldItem(TaskField.BASELINE10_ESTIMATED_DURATION, FieldLocation.VAR_DATA, 1, 65535, 593),
         ...
         new FieldItem(TaskField.START_TEXT, FieldLocation.VAR_DATA, 1, 65535, 1285),
         new FieldItem(TaskField.FINISH_TEXT, FieldLocation.VAR_DATA, 1, 65535, 1286),
         new FieldItem(TaskField.DURATION_TEXT, FieldLocation.VAR_DATA, 1, 65535, 1287),
         new FieldItem(TaskField.BASELINE_START, FieldLocation.VAR_DATA, 1, 65535, 1299),
         new FieldItem(TaskField.BASELINE_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1300),
         new FieldItem(TaskField.BASELINE_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1301),
         new FieldItem(TaskField.BASELINE1_START, FieldLocation.VAR_DATA, 1, 65535, 1302),
         new FieldItem(TaskField.BASELINE1_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1303),
         new FieldItem(TaskField.BASELINE1_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1304),
         new FieldItem(TaskField.BASELINE2_START, FieldLocation.VAR_DATA, 1, 65535, 1305),
         new FieldItem(TaskField.BASELINE2_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1306),
         new FieldItem(TaskField.BASELINE2_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1307),
         new FieldItem(TaskField.BASELINE3_START, FieldLocation.VAR_DATA, 1, 65535, 1308),
         new FieldItem(TaskField.BASELINE3_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1309),
         new FieldItem(TaskField.BASELINE3_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1310),
         new FieldItem(TaskField.BASELINE4_START, FieldLocation.VAR_DATA, 1, 65535, 1311),
         new FieldItem(TaskField.BASELINE4_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1312),
         new FieldItem(TaskField.BASELINE4_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1313),
         new FieldItem(TaskField.BASELINE5_START, FieldLocation.VAR_DATA, 1, 65535, 1314),
         new FieldItem(TaskField.BASELINE5_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1315),
         new FieldItem(TaskField.BASELINE5_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1316),
         new FieldItem(TaskField.BASELINE6_START, FieldLocation.VAR_DATA, 1, 65535, 1317),
         new FieldItem(TaskField.BASELINE6_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1318),
         new FieldItem(TaskField.BASELINE6_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1319),
         new FieldItem(TaskField.BASELINE7_START, FieldLocation.VAR_DATA, 1, 65535, 1320),
         new FieldItem(TaskField.BASELINE7_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1321),
         new FieldItem(TaskField.BASELINE7_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1322),
         new FieldItem(TaskField.BASELINE8_START, FieldLocation.VAR_DATA, 1, 65535, 1323),
         new FieldItem(TaskField.BASELINE8_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1324),
         new FieldItem(TaskField.BASELINE8_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1325),
         new FieldItem(TaskField.BASELINE9_START, FieldLocation.VAR_DATA, 1, 65535, 1326),
         new FieldItem(TaskField.BASELINE9_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1327),
         new FieldItem(TaskField.BASELINE9_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1328),
         new FieldItem(TaskField.BASELINE10_START, FieldLocation.VAR_DATA, 1, 65535, 1329),
         new FieldItem(TaskField.BASELINE10_FINISH, FieldLocation.VAR_DATA, 1, 65535, 1330),
         new FieldItem(TaskField.BASELINE10_DURATION, FieldLocation.VAR_DATA, 1, 65535, 1331)
      };
      return result;
   }
   ...
   @Override protected FieldItem[] getDefaultResourceData()
   {
      FieldItem[] result = new FieldItem[]
      {
         ...
         new FieldItem(ResourceField.CREATED, FieldLocation.VAR_DATA, 1, 65535, 726),
   ...
   @Override protected FieldItem[] getDefaultAssignmentData()
   {
      FieldItem[] result = new FieldItem[]
      {
         ...
         new FieldItem(AssignmentField.DELAY, FieldLocation.FIXED_DATA, 0, 24, 25),
         ...
         new FieldItem(AssignmentField.VARIABLE_RATE_UNITS, FieldLocation.FIXED_DATA, 0, 44, 270),
         new FieldItem(AssignmentField.ASSIGNMENT_UNITS, FieldLocation.FIXED_DATA, 0, 46, 7),
         new FieldItem(AssignmentField.WORK, FieldLocation.FIXED_DATA, 0, 54, 8),
         new FieldItem(AssignmentField.ACTUAL_WORK, FieldLocation.FIXED_DATA, 0, 62, 10),
         new FieldItem(AssignmentField.REGULAR_WORK, FieldLocation.FIXED_DATA, 0, 70, 11),
         new FieldItem(AssignmentField.REMAINING_WORK, FieldLocation.FIXED_DATA, 0, 78, 12),
         new FieldItem(AssignmentField.COST, FieldLocation.FIXED_DATA, 0, 86, 26),
         new FieldItem(AssignmentField.ACTUAL_COST, FieldLocation.FIXED_DATA, 0, 94, 28),
         new FieldItem(AssignmentField.REMAINING_COST, FieldLocation.FIXED_DATA, 0, 102, 29),
         ...
         new FieldItem(AssignmentField.TIMEPHASED_WORK, FieldLocation.VAR_DATA, 0, 65535, 49),
         new FieldItem(AssignmentField.TIMEPHASED_ACTUAL_WORK, FieldLocation.VAR_DATA, 0, 65535, 50),
         ...
         new FieldItem(AssignmentField.BASELINE_START, FieldLocation.VAR_DATA, 0, 65535, 146),
         new FieldItem(AssignmentField.BASELINE_FINISH, FieldLocation.VAR_DATA, 0, 65535, 147),
         new FieldItem(AssignmentField.BASELINE_WORK, FieldLocation.VAR_DATA, 0, 65535, 16),
         new FieldItem(AssignmentField.BASELINE_COST, FieldLocation.VAR_DATA, 0, 65535, 32),
